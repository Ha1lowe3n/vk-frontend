...
const MusicPlayerPauseIcon: React.FC = () => {
    return (
        <svg
            data-testid="MusicPlayerPauseIcon"
            width="24"
            height="24"
            viewBox="0 0 24 24"
...
export default MusicPlayerPauseIcon;
